...
export const Hero: React.FC<HeroProps> = ({ onExploreProjects }) => {
  return (
    <section
      id="hero"
      className="relative min-h-[92vh] sm:min-h-screen pt-32 sm:pt-40 pb-20 sm:pb-28 flex flex-col justify-between items-center bg-grid-pattern border-b border-zinc-200/80 overflow-hidden"
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col items-center justify-center relative z-10 text-center py-6 sm:py-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white border border-zinc-200/90 shadow-[0_2px_8px_rgba(0,0,0,0.03)] mb-6 sm:mb-8"
        >
        ...
        >
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-[70px] font-extrabold text-zinc-950 tracking-tight leading-[1.08]">
            {PERSONAL_INFO.name}
          </h1>

          <p className="text-base sm:text-xl text-zinc-700 font-semibold tracking-tight max-w-2xl mx-auto leading-snug pt-1">
            {PERSONAL_INFO.role} · Exploring Software Engineering &amp; UI/UX
          </p>

          <p className="text-sm sm:text-base text-zinc-500 max-w-xl mx-auto leading-relaxed font-normal pt-1.5">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3.5 pt-7 sm:pt-8"
        >
          <button
            id="hero-explore-work-btn"
            onClick={onExploreProjects}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-zinc-950 hover:bg-purple-700 hover:-translate-y-0.5 text-white font-semibold text-sm transition-all shadow-xs hover:shadow-sm active:scale-95 cursor-pointer"
          >
          ...
          <a
            ...
            href="#contact"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white border border-zinc-300 text-zinc-800 hover:border-purple-300 hover:text-purple-700 hover:-translate-y-0.5 font-semibold text-sm transition-all shadow-2xs active:scale-95"
          >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-2.5 pt-8 sm:pt-10 text-xs text-zinc-600"
        >
          <span className="px-3.5 py-1.5 rounded-full bg-white border border-zinc-200/80 font-mono-meta shadow-2xs">
