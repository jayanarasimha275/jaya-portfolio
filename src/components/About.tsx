      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-start">
            ...
            <h2
              id="about-heading"
              className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight text-zinc-950 mb-6 leading-tight"
            >
            ...
            <div className="w-full p-6 rounded-2xl bg-white border border-zinc-200/90 shadow-xs space-y-4">
              <div className="flex items-start gap-3.5">
                <div className="p-2.5 rounded-xl bg-purple-50 border border-purple-100 text-purple-700">
                  <GraduationCap className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-xs font-mono-meta text-purple-700 uppercase tracking-wider block font-semibold">
                    Current Institution
                  </span>
                  <h3 className="text-base font-bold text-zinc-900 mt-0.5">SRM University-AP</h3>
                  <p className="text-xs text-zinc-500 mt-0.5">B.Tech Computer Science &amp; Engineering</p>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-zinc-100 flex items-center justify-between text-xs text-zinc-500">
                ...
                <span className="font-semibold text-purple-700">2nd Year</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-white border border-zinc-200/90 shadow-xs relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-purple-50 rounded-full blur-3xl pointer-events-none" />
              
              <p className="text-xl sm:text-2xl font-medium text-zinc-900 leading-snug tracking-tight mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-2xl bg-white border border-zinc-200/80">
